        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {services.map((service, index) => (
            ...
            >
              ...
              <div
                className={`absolute top-0 left-0 right-0 h-1 ${service.accent === "brand-blue" ? "bg-brand-blue" : "bg-brand-green"} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left`}
              />

              <div
                className={`w-14 h-14 ${service.accent === "brand-blue" ? "bg-brand-blue/10" : "bg-brand-green/10"} rounded-xl flex items-center justify-center mb-5`}
              >
                <service.icon className={`w-7 h-7 ${service.accent === "brand-blue" ? "text-brand-blue" : "text-brand-green"}`} />
              </div>
