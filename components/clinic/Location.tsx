        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {contactInfo.map((info, index) => (
            <motion.div
              ...
              className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300 border border-brand-blue/10"
            >
              ...
              <div className="space-y-1">
                {info.content.map((line, i) => (
                  <p key={i} className="text-brand-blue/80">
                    {info.links?.[i] ? (
                      <a
                        href={info.links[i]}
